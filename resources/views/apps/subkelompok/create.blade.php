    ...
    <main id="main" class="main">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mr-4 pr-4">Tambah Data Subkelompok</h4>
                        <form action="{{ route('subkelompok-create-submit') }}" method="POST" class="mx-2">
                            @csrf
                            ...
                            <div class="row g-3 mb-3 align-items-center">
                                ...
                                <div class="col-7">
                                    <input type="text" id="nama_katim" name="nama_katim"
                                        ...
                                        autocomplete="off" value="{{ old('nama_katim') }}" required>
                                    @error('nama_katim')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-7">
                                    <select class="form-select @error('subkelompok_id') is-invalid @enderror"
                                        ...
                                        @foreach ($kelompoks as $kelompok)
                                            @if (old('subkelompok_id') == $kelompok->id)
