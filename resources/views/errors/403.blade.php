...
<head>
  ...
  <link href="{{ asset('admin/assets/img/logo-kementan.png') }}" rel="logo-kementan.png">
  ...
  <main>
    <div class="container">
      ...
      <section class="section error-500 min-vh-100 d-flex flex-column align-items-center justify-content-center">
        <img src="{{ asset('admin/assets/img/logo-kementan.png') }}" class="img-fluid py-5" width="200" height="200" alt="logo-kementan">
        <h1>403</h1>
        <h2>Forbidden!.</h2>
